        ...
        <div id="revolution-slider">
            <ul>
                <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="">
                    <!--  BACKGROUND IMAGE -->
                    <img src="/assets/images/slider/wide1.jpg" alt="" />
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="">
                    <!--  BACKGROUND IMAGE -->
                    <img src="/assets/images/slider/wide2.jpg" alt="" />
                ...
                <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="">
                    <!--  BACKGROUND IMAGE -->
                    <img src="/assets/images/slider/wide3.jpg" alt="" />
                    <div class="tp-caption big-white sft" data-x="0" data-y="160" data-speed="800" data-start="400" data-easing="easeInOutExpo"
                        data-endspeed="450">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 wow fadeInLeft">
                    <h3><span class="id-color">LOW COST</span> Housing</h3>
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque
                    ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
                    <div class="spacer-single"></div>
                    <a class="image-popup-no-margins" href="/assets/images/misc/pic_1.jpg">
                        <img src="/assets/images/misc/pic_1.jpg" class="img-responsive" alt="">
                    </a>
                    <a href>See More details</a>
                </div>

                <div class="col-md-4 wow fadeInUp" data-wow-delay=".2s">
                    <h3><span class="id-color">REFURBISHING</span> Houses</h3>
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque
                    ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
                    <div class="spacer-single"></div>
                    <img src="/assets/images/misc/pic_2.jpg" class="img-responsive" alt="">
                    <a href>See More details</a>
                </div>

                <div class="col-md-4 wow fadeInRight">
                    <h3><span class="id-color">SELLING OF</span> LAND</h3>
                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque
                    ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
                    Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
                    <div class="spacer-single"></div>
                    <img src="/assets/images/misc/pic_3.jpg" class="img-responsive" alt="">
                    <a href>See More details</a>
                </div>
        ...
        <div id="gallery" class="gallery full-gallery de-gallery pf_full_width wow fadeInUp" data-wow-delay=".3s">
            ...
            <div class="item residential">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(1).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item hospitaly">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(2).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item hospitaly">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(3).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item residential">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(4).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item office">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(5).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item commercial">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(6).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item residential">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(7).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
            ...
            <div class="item office">
                <div class="picframe">
                    ...
                    <img src="/assets/images/portfolio/cols-4/pf%20(8).jpg" alt="" />
                </div>
            </div>
            <!-- close gallery item -->
