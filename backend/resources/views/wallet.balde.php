...
<div class="clearfix">
<div class="widget-icon widget-icon-xl user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-id="widget-elm" data-light-class="widget-icon widget-icon-xl user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-dark-class="widget-icon widget-icon-xl user rounded bg-inverse float-start me-5px mb-5px text-white-transparent-5">
<i class="fa fa-user"></i>
</div>
<div class="widget-icon widget-icon-lg user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-id="widget-elm" data-light-class="widget-icon widget-icon-lg user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-dark-class="widget-icon widget-icon-lg user rounded bg-inverse float-start me-5px mb-5px text-white-transparent-5">
<i class="fa fa-user"></i>
</div>
<div class="widget-icon user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-id="widget-elm" data-light-class="widget-icon user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-dark-class="widget-icon user rounded bg-inverse float-start me-5px mb-5px text-white-transparent-5">
<i class="fa fa-user"></i>
</div>
<div class="widget-icon widget-icon-sm user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-id="widget-elm" data-light-class="widget-icon widget-icon-sm user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-dark-class="widget-icon widget-icon-sm user rounded bg-inverse float-start me-5px mb-5px text-white-transparent-5">
<i class="fa fa-user"></i>
</div>
<div class="widget-icon widget-icon-xs user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-id="widget-elm" data-light-class="widget-icon widget-icon-xs user rounded bg-gray-500 float-start me-5px mb-5px text-white" data-dark-class="widget-icon widget-icon-xs user rounded bg-inverse float-start me-5px mb-5px text-white-transparent-5">
<i class="fa fa-user"></i>
</div>
</div>
</div>
...
<div class="widget-card-content">
<h5 class="fs-12px text-black-transparent-7" data-id="widget-elm" data-light-class="fs-12px text-black-transparent-7" data-dark-class="fs-12px text-white-transparent-7"><b>MAKING A DIFFERENCE</b></h5>
<h4 class="mb-10px text-pink"><b>Apple Heart<br /> Study App</b></h4>
<i class="fa fa-heartbeat fa-5x text-pink-transparent-5"></i>
</div>
<div class="widget-card-content bottom">
<b class="text-black-transparent-7" data-id="widget-elm" data-light-class="fs-12px text-black-transparent-7" data-dark-class="fs-12px text-white-transparent-7">Opt in and help heart research.</b>
</div>
</a>
...
status:
<b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white">Shipped</b>
</div>
</td>
<td class="text-nowrap">
<b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white">$999</b><br />
<small class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white"><del>$1,202</del></small>
</td>
<td>1</td>
<td>999.00</td>
<td>
<a href="#" class="btn btn-inverse btn-sm w-80px rounded-pill" data-id="widget-elm" data-light-class="btn btn-inverse btn-sm w-80px rounded-pill" data-dark-class="btn btn-default btn-sm w-80px rounded-pill">Edit</a>
</td>
</tr>
<tr>
<td>
...
<div class="clearfix fs-10px">
status:
<b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white">received</b>
</div>
</td>
<td class="text-nowrap">
<b class="text-inverse" data-id="widget-elm" data-light-class="text-inverse" data-dark-class="text-white">$999</b><br />
